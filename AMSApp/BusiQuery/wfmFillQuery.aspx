<%@ Page language="c#" Codebehind="wfmFillQuery.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.BusiQuery.wfmFillQuery" %>
	...
	<body MS_POSITIONING="GridLayout" onload="<%=strExcelPath%>" bgcolor="#feeff8">
		<FORM id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="5" width="95%" border="0">
				<TR>
					<TD style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033" align="center">会员充值查询</TD>
				</TR>
			</TABLE>
