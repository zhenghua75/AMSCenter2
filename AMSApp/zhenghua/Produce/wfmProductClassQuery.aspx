<%@ Page language="c#" Codebehind="wfmProductClassQuery.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Produce.wfmProductClassQuery" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="5" width="95%" border="0">
				<TR>
					<TD style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033" align="center">大类类别统计</TD>
				</TR>
			</TABLE>
