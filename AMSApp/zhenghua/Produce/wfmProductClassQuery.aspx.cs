...
namespace AMSApp.zhenghua.Produce
{
	...
	/// wfmCostReport 的摘要说明。
	/// </summary>
	public class wfmProductClassQuery : wfmBase
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!this.IsPostBack)
			{
				...
				//this.BindOper(ddlOper,"vcDeptID='"+this.ddlDept.SelectedValue+"'");
				this.txtBeginDate.Text = DateTime.Now.ToString("yyyy-MM-dd");
				this.txtEndDate.Text = DateTime.Now.ToString("yyyy-MM-dd");
				//this.txtOperDate.Text = DateTime.Now.ToString("yyyy-MM-dd");
		...
		{
			DataTable dtOut1 = Helper.QueryLongTrans("ProductClassQuery '"+ddlDept.SelectedValue+"','"+txtBeginDate.Text+"','"+txtEndDate.Text+"'");			
			return dtOut1;
		}
		private void Button1_Click(object sender, System.EventArgs e)
		{
			...
			this.ExportToXls(this,"大类类别统计",str);
		}
