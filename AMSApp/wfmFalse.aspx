<%@ Page language="c#" Codebehind="wfmFalse.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.wfmFalse" %>
				...
				<tr>
					<td>
						...
						<TABLE style="HEIGHT: 110px" cellSpacing="1" cellPadding="3" width="100%" align="center"
							...
							<TR>
								<TD align="center">
									<INPUT type="button" style="CURSOR:hand" value="返  回" onClick="javascript:window.location='wfmWelcome.aspx'"></TD>
							</TR>
						</TABLE>
					</td>
				</tr>
