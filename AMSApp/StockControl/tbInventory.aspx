<%@ Page Language="c#" Title="存货档案" MasterPageFile="~/StockControl/StockControl.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dlg" style="width: 500px; height: 280px; padding: 10px 20px">
        ...
        <div class="fitem">
            <label>
                存货编码：</label>
            <input id="cnvcInvCode" name="cnvcInvCode" class="easyui-validatebox" validtype="InvCode" required="true" />
        </div>
        <div class="fitem">
            <label>
                存货名称：</label>
