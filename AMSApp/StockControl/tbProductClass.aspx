<%@ Page language="c#" Title="存货分类" MasterPageFile="~/StockControl/StockControl.Master" Codebehind="tbProductClass.aspx.cs" AutoEventWireup="true" Inherits="AMSApp.StockControl.tbProductClass" %>
