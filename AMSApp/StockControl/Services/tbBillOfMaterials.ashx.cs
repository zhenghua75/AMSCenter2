...
namespace AMSApp.StockControl.Services
{
    ...
    /// 配方
    /// </summary>
    public class tbBillOfMaterials : IHttpHandler, IRequiresSessionState
    {
        ...
        private IQueryable<AMSCM.Models.tbBillOfMaterials> QueryCondition(HttpContext context, AMSCM.Models.AMSCM amscm)
        {
            ...
            var q = from p in amscm.tbBillOfMaterials select p;
        ...
        private DataTable List2DataTable(HttpContext context, List<AMSCM.Models.tbBillOfMaterials> ltbBillOfMaterials)
        {
            DataTable dt = ltbBillOfMaterials.ToDataTable<AMSCM.Models.tbBillOfMaterials>();
        ...
        private string newtbBillOfMaterials(HttpContext context)
        {
            try
            {
                using (AMSCM.Models.AMSCM amscm = new AMSCM.Models.AMSCM())
                {
                    AMSCM.Models.tbBillOfMaterials tbBillOfMaterials = new AMSCM.Models.tbBillOfMaterials();
                    ...
                    amscm.tbBillOfMaterials.Add(tbBillOfMaterials);
                    amscm.SaveChanges();
                }
            }
