...
namespace AMSApp.StockControl.Services
{
    ...
    /// 库存子表
    /// </summary>
    public class tbStockDetail : IHttpHandler, IRequiresSessionState
    {
        ...
        private IQueryable<AMSCM.Models.tbStockDetail> QueryCondition(HttpContext context, AMSCM.Models.AMSCM amscm)
        {
            ...
            var q = from p in amscm.tbStockDetail select p;
        ...
        private DataTable List2DataTable(HttpContext context, List<AMSCM.Models.tbStockDetail> ltbStockDetail)
        {
            DataTable dt = ltbStockDetail.ToDataTable<AMSCM.Models.tbStockDetail>();
            return dt;
        }
