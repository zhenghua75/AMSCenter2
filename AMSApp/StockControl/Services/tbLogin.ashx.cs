...
namespace AMSApp.StockControl.Services
{
    ...
    /// tbLogin 的摘要说明
    /// </summary>
    public class tbLogin : IHttpHandler, IRequiresSessionState
    {
        ...
        private IQueryable<tbLoginSub> QueryCondition(HttpContext context, AMSCM.Models.AMSCM amscm)
        {
            ...
            var q = from p in amscm.tbLogin select new tbLoginSub { vcDeptID = p.vcDeptID, vcLoginID = p.vcLoginID, vcOperName = p.vcOperName };
