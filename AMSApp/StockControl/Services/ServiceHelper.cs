...
namespace AMSApp.StockControl.Services
{
    ...
    /// </summary>
     ...
     public class ServiceHelper
     {
         ...
         public static string DataTableToEasyUIDataGridJson(DataTable dt, string totalcount)
         {
             ...
             foreach (DataRow dr in dt.Rows)
             {
                 ...
                 foreach (DataColumn dc in dt.Columns)
                 {
                     ...
                     {
                         str = dr[dc.ColumnName].ToString().TrimEnd('0').TrimEnd('.');
         ...
         //public static void DataTableConvert(HttpContext context, DataTable dt, string columnName,string newColumnName, string strApplicationName, string strIDColumnName, string strCommentsColumnName)
         //{
         //    DataTableConvert(context, dt, columnName, newColumnName, strApplicationName, strIDColumnName, strCommentsColumnName, "");
         //}
         ...
         public static List<AMSCM.Models.tbBillOfMaterials> ProcBOM(List<AMSCM.Models.tbBillOfMaterials> ltbBillOfMaterials, string strinvcode)
         {
             ...
             foreach (AMSCM.Models.tbBillOfMaterials bom in l)
             {
         ...
         public static List<AMSCM.Models.tbBillOfMaterials> ProcBOM2(List<AMSCM.Models.tbBillOfMaterials> ltbBillOfMaterials, string strinvcode)
         {
