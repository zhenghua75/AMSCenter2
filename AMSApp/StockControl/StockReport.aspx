<%@ Page Title="" Language="C#" MasterPageFile="~/StockControl/StockControl.Master"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="toolbar">
        <a href="#" class="easyui-linkbutton" iconcls="icon-search" plain="true" onclick="searchStockReport();return false;">
            搜索</a> <a href="#" class="easyui-linkbutton" iconcls="icon-save" plain="true" onclick="StockReportExportToExcel();return false;">
                导出</a>
                <a href="#" class="easyui-linkbutton" iconcls="icon-edit" plain="true" onclick="costStockReport();return false;">
                计算成本</a>
    </div>
    ...
    <div id="search-dlg-buttons">
     ...
     <div id="cost-dlg" style="width: 400px; height: 280px; padding: 10px 20px">
        <div class="ftitle">
            计算成本</div>
        ...
        <div class="fitem">
            ...
            <input id="cost-cnnYear" name="cnnYear" class="easyui-validatebox" />
        </div>
        <div class="fitem">
            <label>
                月
            </label>
            <input id="cost-cnnMonth" name="cnnMonth" class="easyui-validatebox" />
        </div>
        </form>
    </div>
    <div id="cost-dlg-buttons">
        <a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="StockReportCost();return false;">
            计算成本</a> <a href="#" class="easyui-linkbutton" iconcls="icon-cancel" onclick="javascript:$('#cost-dlg').dialog('close');return false;">
                取消</a>
    </div>
