...
<head runat="server">
    <title>靓丽妆品网络中心</title>
    <link rel="stylesheet" type="text/css" href="StockControl/scripts/jquery-easyui-1.3.3/themes/bootstrap/easyui.css" />
    <link rel="stylesheet" type="text/css" href="StockControl/scripts/jquery-easyui-1.3.3/themes/icon.css" />
    <script type="text/javascript" src="StockControl/scripts/jquery-easyui-1.3.3/jquery.min.js"></script>
    <script type="text/javascript" src="StockControl/scripts/jquery-easyui-1.3.3/jquery.easyui.min.js"></script>
    <script src="StockControl/scripts/jquery-easyui-1.3.3/locale/easyui-lang-zh_CN.js" type="text/javascript"></script>
...
<body class="easyui-layout">
    ...
    <div region="north" style="height: 80px; overflow: hidden">
        <div style="margin: 0 0 0 0;">
            <img alt="靓丽妆品网络管理中心" src="image/banner.jpg" style="height: 80px; width: 100%; margin: 0 0 0 0;" />
        </div>
            ...
            <div title="销售报表">
                <ul>
                    ...
                    <li runat="server" id="liFillQuery" visible="false"><a href="BusiQuery/wfmFillQuery.aspx"
                        iconcls="icon-gnome-main-menu" plain="true" class="easyui-linkbutton" onclick="AddTab(this);return false;">
                        会员充值查询</a> </li>
                     <li runat="server" id="liIGQuery" visible="false"><a href="BusiQuery/wfmIGQuery.aspx"
                        iconcls="icon-gnome-main-menu" plain="true" class="easyui-linkbutton" onclick="AddTab(this);return false;">
                        会员积分查询</a> </li>
