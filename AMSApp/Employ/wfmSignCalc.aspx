<%@ Page language="c#" Codebehind="wfmSignCalc.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.Employ.wfmSignCalc" %>
					...
					<TD>
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD>
									<asp:button id="btQuery" runat="server" Font-Size="10pt" Width="96px" Text="查询计算情况"></asp:button></TD>
							</TR>
							<TR>
								...
								<TD><FONT face="宋体">
										<asp:button id="btCalc" runat="server" Font-Size="10pt" Width="80px" Text="开始计算"></asp:button></FONT></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
