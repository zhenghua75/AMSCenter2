			...
			<FORM id="Form1" method="post" bgcolor="#feeff8" runat="server">
						...
						<TD>
							<TABLE id="Table2" cellSpacing="0" cellPadding="1" width="100%" border="0">
								...
								<TR>
									...
									<TD style="WIDTH: 158px"><asp:button id="btquery" runat="server" Width="65px" Text="查询"></asp:button></TD>
									<TD style="WIDTH: 137px"><asp:button id="btrefresh" runat="server" Width="65px" Text="重新选择"></asp:button></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
				...
				<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="95%" align="center" border="0">
					<TR>
						...
						<td align="center" rowSpan="2"><asp:button id="btOk" runat="server" Width="85px" Height="49px" Text="提交保存"></asp:button></td>
					</TR>
					<TR>
						...
						<td style="WIDTH: 10%" align="center">
							<P><asp:button id="Button1" runat="server" Width="68px" Font-Size="10pt" Text="添加>>"></asp:button></P>
							<P><asp:button id="Button2" runat="server" Width="68px" Font-Size="10pt" Text="<<取消"></asp:button></P>
						</td>
