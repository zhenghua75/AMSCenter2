...
namespace AMSApp.Employ
{
	...
	/// </summary>
	public class wfmWorkDaily : wfmBase
	{
		...
		protected System.Web.UI.WebControls.Label lblSchedTitle;
		protected System.Web.UI.WebControls.ListBox ltbAllEmp;
		protected System.Web.UI.WebControls.ListBox ltbSchedEmp;
		...
		protected System.Web.UI.WebControls.DropDownList ddlOfficer;
...
//				}
		...
		{    
			this.ddlOfficer.SelectedIndexChanged += new System.EventHandler(this.ddlOfficer_SelectedIndexChanged);
		...
		private void ddlOfficer_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			ddlClass.Items.Clear();
			string strOfficer=ddlOfficer.SelectedValue;
			Hashtable htTime=(Hashtable)Application["IOTime"];
